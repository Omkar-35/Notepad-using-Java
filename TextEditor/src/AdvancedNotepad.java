...
//                 Main class
//////////////////////////////////////////////////////////////////////////////
public final class AdvancedNotepad extends JFrame {
...
//    JToolBar _toolbar;
    ...
    public AdvancedNotepad() {
        ...
        // add MenuListener to menu items
        JMenuItem[] editmenuitems = { edit_cut, edit_copy, edit_paste, edit_undo, edit_redo, edit_find, edit_replace,
                edit_goto, edit_selectall,
                edit_changecase_upper, edit_changecase_lower, edit_changecase_sentence, edit_nextdocument,
                edit_previousdocument };
...
//        view_lookandfeel_nimbus.addActionListener(view_action);
        ...
        JMenuItem help_about = new JMenuItem("  About Us");
...
//        }
        ...
        // **************************************************************
        // get content pane & adding statusbar & jsplit to it
        // ***************************************************************
            ...
            if (evt.getSource() instanceof JMenuItem) {
                ...
                switch (item) {
                    ...
                    case "Open In System Editor":
                        File_OpenInSystemEditor_Action();
                        break;
                    case "Exit":
                        File_Exit_Action();
                        break;
                    ...
                    case "About Us":
                        JOptionPane.showMessageDialog(null, "   'Advanced Tabbed Notepad in Java'\nCourse Project by CS-C, B02 - Group 06", "About Us",
            ...
            if (evt.getSource() instanceof JMenuItem) {
                ...
                switch (item) {
                    case "Font":
                        ...
                        break;
                    case "Fore Color":
                        View_ForeColor_Action();
                        break;
                    case "Back Color":
                        View_BackColor_Action();
                        break;
                    case "Top":
                        View_TabsAlignment_Action("top");
                        break;
                    case "Bottom":
                        View_TabsAlignment_Action("bottom");
                        break;
                    case "Left":
                        View_TabsAlignment_Action("left");
                        break;
                    case "Right":
                        View_TabsAlignment_Action("right");
                        break;
                    case "Java":
                        View_SetLookAndFeel_Action("java");
                        break;
                    case "Motif":
                        View_SetLookAndFeel_Action("motif");
                        break;
//                    case "Nimbus":
//                        View_SetLookAndFeel_Action("nimbus");
//                        break;
                    case "Windows":
                        View_SetLookAndFeel_Action("windows");
                        break;
                    case "Windows Classic":
                        View_SetLookAndFeel_Action("windowsclassic");
                        break;
                    case "Global Dark":
                        View_SetLookAndFeel_Action("globaldark");
                        break;
                }
            }
        }
    ...
    public void File_Save_Action() {
        if (_tabbedPane.getTabCount() > 0) {
            ...
            JTextPane textPane = (JTextPane) (((JScrollPane) _tabbedPane.getComponentAt(sel)).getViewport())
                    .getComponent(0);
    ...
    public void Edit_Paste_Action() {
        if (_tabbedPane.getTabCount() > 0) {
            ...
            JTextPane textPane = (JTextPane) (((JScrollPane) _tabbedPane.getComponentAt(sel)).getViewport())
                    .getComponent(0);
            Transferable cliptran = clip.getContents(AdvancedNotepad.this);
            try {
        ...
        switch (type) {
            case "java": {
                int n = JOptionPane.showConfirmDialog(null,
                        "Click OK to restart the application & to set Basic Java Metal look and feel theme",
                        "Set Basic Java Metal Look and feel", JOptionPane.OK_CANCEL_OPTION,
                        JOptionPane.INFORMATION_MESSAGE);
                if (n == 0) {
                    File_CloseAll_Action();
                    dispose();
            ...
            case "motif": {
                int n = JOptionPane.showConfirmDialog(null,
                        "Click OK to restart the application & to set Motif look and feel theme",
...
//            case "nimbus": {
//                int n = JOptionPane.showConfirmDialog(null,
//                        "Click OK to restart the application & to set Nimbus look and feel theme",
...
//            }
            case "windows": {
                int n = JOptionPane.showConfirmDialog(null,
                        "Click OK to restart the application & to set Windows look and feel theme",
            ...
            case "windowsclassic": {
                int n = JOptionPane.showConfirmDialog(null,
                        "Click OK to restart the application & to set Windows Classic look and feel theme",
                        "Set Windows Classic Look and feel", JOptionPane.OK_CANCEL_OPTION,
                        JOptionPane.INFORMATION_MESSAGE);
                if (n == 0) {
                    File_CloseAll_Action();
                    dispose();
            ...
            case "globaldark": {
                int n = JOptionPane.showConfirmDialog(null,
                        "Click OK to restart the application & to set Global Dark look and feel theme",
    ...
    public static void main(String args[]) {
        // start application with theme by reading nodetag lookAndFeel from file
        // viewsfile.xml
